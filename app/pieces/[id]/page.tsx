          ...
          {pieceData && (
            <div className="flex flex-col items-center justify-center w-full pt-[80px]">
              <div className="flex flex-col items-center justify-center gap-12">
                ...
                <section >
                  <Link className=" h-14 p-5 bg-violet-600 rounded justify-center items-center gap-3 inline-flex" href={"https://www.activepieces.com/docs/pieces/apps/" + pieceName} target="_blank" rel="noopener noreferrer" >
                    <div className="text-center text-white text-2sm leading-loose tracking-wide flex gap-2 items-center">Go to documentation <Image src="/chevron.svg" alt="chevron" height={14} width={7} className="mt-1"></Image></div>
                  </Link>
                </section>
              </div>
