        ...
        <section className="bg-white pb-[23.875rem] lg:pb-[13.875rem] px-4 lg:px-0 ">
            <div className='mx-auto container'>
                <div className="flex flex-col gap-[25px] items-center justify-center">
                    ...
                    <div className='w-full bg-[#FAFAFA] relative border border-solid border-black flex flex-col rounded-[12px]'>
                        <div className='flex p-4 justify-between text-[12.44px]  text-black border-b border-solid border-[#D2D2D2]'>
                            <div className='hidden lg:flex items-center gap-[9px]'>
                                ...
                                <div className='text-[12.44px]  text-[#C8C8C8]'>
                                    /
                                </div>
                                <div className='font-bold text-[12.44px]  text-opacity-90'>
                                    Flow Name
                                </div>
                            ...
                            <div className='lg:absolute w-full'>
                                <div className=' w-full '>
                                    <div className='text-[14px] h-[22px] items-center mt-[3px] justify-start lg:justify-center items-center flex font-semibold gap-[10px]'>
                            ...
                            <div className='flex items-center gap-[14px]'>
                                <div className='text-white text-[14px] bg-[#0BA970] rounded-[4px] w-[70px] h-[28px] flex items-center justify-center'>
                                    Publish
                                </div>
                                <div className='rounded-full text-white bg-[#515151] h-[28px] w-[28px] flex items-center justify-center text-[12.4px]'>
                                    Y
                                </div>
                            </div>
                        </div>
                        <div className='p-4 md:py-12 md:px-14 w-full h-[472px] lg:h-[614px]'>
                            <div className='flex items-center bg-white px-6 lg:px-0 py-6 lg:py-24 border border-solid border-black rounded-lg flex-col gap-[40px] md:gap-[60px]'>
                                <div className='text-2xl font-bold max-w-[42.815rem] text-center lg:text-4xl'>
