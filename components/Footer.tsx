  ...
  return (
    <footer className=" lg:text-left text-[#C3C3C3] bg-[#000000]">
      <div className="px-4 lg:px-0 flex items-center h-[1px]">
        <div className="w-full border-[#242424] border-solid border-t"></div>
      </div>
      ...
      <div className="mx-auto container flex-wrap items-center px-4 lg:px-0 flex justify-center lg:justify-between py-[40px] sm:gap-x-5 gap-x-0">
        ...
        <div className="flex gap-[15px] w-[210px] flex-wrap md:w-[initial] justify-center lg:justify-start mt-[40px] sm:mt-0">
