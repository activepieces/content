...
export const GithubStickyWidget = ({ stars }: { stars: number }) => {
    ...
    return <>
        <div className={hide ? "hidden" : "sticky w-full flex justify-center bottom-[30px]"}>
            <div className="bg-[#06FFB4] border border-solid border-black border-opacity-50 h-[95px] w-[350px] lg:w-[500px] rounded-xl text-h6-sm lg:text-h6-lg !font-bold  flex justify-center gap-[20px] lg:gap-[50px] items-center">
                Star us on Github <GithubWidget stars={stars} ></GithubWidget> <svg onClick={() => setHide(true)} className="cursor-pointer" width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
