            ...
            <section className='bg-black text-white text-[50px] font-bold leading-[60px] lg:text-[80px] px-4 lg:px-0 pb-[100px] lg:pb-[150px]'>
                <div className='container justify-between mx-auto py-[40px] lg:py-[80px] flex gap-0 flex-wrap lg:flex-nowrap mb-[40px] lg:mb-[80px]'>
                    ...
                    <h1 className='lg:items-start flex max-w-[962.37px] gap-[20px] lg:gap-[25px] items-center flex-wrap'>
                        Automate your <div className=' relative '>
                            <div className='z-20 relative'>marketing</div>
                            <div className='absolute -rotate-[0.35deg] -bottom-[11px] z-10'>
                                <svg width="361" height="9" viewBox="0 0 361 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='relative'>
                            ...
                            <div className='absolute -rotate-[1deg] -bottom-[14px] z-10'>
                                <svg width="171" height="11" viewBox="0 0 171 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex flex-col justify-end grow mt-[40px] lg:grow-0 lg:mt-[0px]'>
                        <Link href="https://cloud.activepieces.com/sign-up" target='_blank' rel='noopner' className='text-center hover:-translate-y-[6px] transition-transform  text-h4-sm lg:text-h4-lg text-white bg-primary py-[15px] px-[35px] whitespace-nowrap'>
                            Get Started
                        </Link>
                    </div>
                </div>
