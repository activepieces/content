        ...
        <section className="bg-white px-4 lg:px-0 py-[100px] lg:py-[150px]">
            <div className="mx-auto container">
                ...
                <div className='mt-[40px] lg:mt-[60px] items-center justify-between flex-wrap flex gap-5 text-h3-sm lg:text-h3-lg '>
                    ...
                    <Link href="https://cloud.activepieces.com/sign-up" target='_blank' rel='noreferer noopener' className='items-center justify-center px-[43px] w-full lg:w-[initial]  lg:py-[10px] py-[26px] bg-black text-white lg:text-h4-lg text-h4-sm flex gap-5 '>
