...
export const RequestedAndInProgressIssues = (props: { issues: GitHubIssue[], search: string, showEmptyResult: boolean, votes: Tables<'voting'>[], vote: (issueId: string, userState: User | null) => void, userState: User | null }) => {
