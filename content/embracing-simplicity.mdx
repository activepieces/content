...
description: Activepieces approach to be unopinionated software
updatedAt: 2023-07-05
author: Mohammad AbuAboud
thumbnail: /blogs/simplicity-approach.jpeg
---
...
At Activepieces, we've introduced a simple yet powerful concept called "pieces." These pieces, consisting of triggers and actions, act as building blocks that empower users to extend the software.
By leveraging these pieces, users can easily customize the software to meet their specific requirements.
...
Don't forget to star us on GitHub (https://github.com/activepieces/activepieces).